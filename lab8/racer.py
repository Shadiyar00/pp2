...
background = pygame.image.load("C:\\Users\\Admin\\Desktop\\pp2\\lab8\\images\\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("C:\\Users\\Admin\\Desktop\\pp2\\lab8\\images\\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("C:\\Users\\Admin\\Desktop\\pp2\\lab8\\images\\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        original_image = pygame.image.load("C:\\Users\\Admin\\Desktop\\pp2\\lab8\\images\\coin.png")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound("C:\\Users\\Admin\\Desktop\\pp2\\lab8\\images\\crash.wav").play()
          time.sleep(1)
